    ...
    return (
        <div >
            <div style={{ marginBottom: `20px` }}>
                <Titulos text={`NUEVO PRODUCTO`} level={3}></Titulos>
            </div>
            <Form
                name="basic"
                layout="vertical"
            ...
            >
                ...
                <Form.Item label='Descripción' name="description" ><Input placeholder='Descripción' value={description} onChange={(e) => setdescription(e.target.value)} /></Form.Item>
                <Form.Item label='Precio' name="precio" rules={[{ required: true, message: 'Cargue precio', },]}><Input type="number" placeholder='Precio' value={precio} onChange={(e) => setprecio(e.target.value)} /></Form.Item>
