...
import { createProductHeader } from '../../services/product_header';
import { Titulos } from '../Utils/Titulos';

function NewProductHeader({ token }) {
...
return (
    <div >
        <div style={{ marginBottom: `20px` }}>
            <Titulos text={`NUEVO TÍTULO PRODUCTO`} level={3}></Titulos>
        </div>
        <Form
            name="basic"
            layout="vertical"
